...
class DailyTaskControllerTest {
    ...
    @Test
    void shouldFinishedScore() {
        //given
        EasyTask eatBreakfast = new EasyTask(TaskStatus.FINISHED,"zjedz sniadanko");
        EasyTask doNotEatSweets = new MediumTask("nie jedz słodyczy");
        EasyTask doExercises = new HardTask("idz na silke");
    ...
    @Test
    void shouldFinishedScore2() {
        //given
        EasyTask eatBreakfast = new EasyTask(TaskStatus.FINISHED,"zjedz sniadanko");
        EasyTask doNotEatSweets = new MediumTask("nie jedz słodyczy");
        EasyTask doExercises = new HardTask(TaskStatus.FINISHED,"idz na silke");
        dailyTaskController.add(eatBreakfast);
        dailyTaskController.add(doNotEatSweets);
        dailyTaskController.add(doExercises);
    ...
    @Test
    void shouldFinishedScore3() {
        //given
        EasyTask eatBreakfast = new EasyTask(TaskStatus.FINISHED, "zjedz sniadanko");
        EasyTask doNotEatSweets = new MediumTask(TaskStatus.FINISHED,"nie jedz słodyczy");
        EasyTask doExercises = new HardTask(TaskStatus.FINISHED,"idz na silke");
